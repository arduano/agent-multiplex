# Protocol-v6 mock Docker scale acceptance

This deterministic suite runs the production protocol-v6 process boundaries:
...
limit. Passing establishes that the protocol-v6 control-node catalog,
...
original protocol/source identity and do not qualify v6. The mock adapter does
not qualify native Copilot lifecycle behavior.
