# Protocol-v6 live four-container acceptance
...
- the gateway projects one protocol-v6 authority and two simultaneously online
...
original protocol/source identity and do not qualify v6. No live/native
protocol-v6 receipt has been produced for the lifecycle change; running this
suite still requires explicit model-credit authorization.
